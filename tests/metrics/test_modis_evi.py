...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "fixtures/metrics/modis-evi/rothschild-giraffe-data.json",
        ),
        (
            "fixtures/shapes/romania-feature-collection.geojson",
            "fixtures/metrics/modis-evi/romania-data.json",
        ),
        (
            "fixtures/shapes/spain-feature-collection.geojson",
            "fixtures/metrics/modis-evi/spain-data.json",
        ),
        (
...
@pytest.mark.parametrize(
    ...
    [
        (
            "fixtures/shapes/rothschild-giraffe-feature-collection.geojson",
            "fixtures/metrics/modis-evi/rothschild-giraffe-gridded-data.json",
        ),
        # (
        #     "fixtures/shapes/canada-feature-collection.geojson",
...
def test_compute_grid(shape_path, metric_path):
    ...
    handler = ModisEvi(grid=True, simplify=True, best_effort=False)
...
def test_throw_area_exception(shape_path, metric_path):
    ...
    handler = ModisEvi(use_exceeds_limit=True)
