...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "fixtures/metrics/terrestrial-carbon/rothschild-giraffe-data.json",
        ),
        (
        ...
        (
            ...
            "fixtures/metrics/terrestrial-carbon/canada-data.json",
        ),
        (
            "fixtures/shapes/africa-feature-collection.geojson",
            "fixtures/metrics/terrestrial-carbon/africa-data.json",
        ),
        (
            "fixtures/shapes/russia-feature-collection.geojson",
            "fixtures/metrics/terrestrial-carbon/russia-data.json",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            "fixtures/shapes/rothschild-giraffe-feature-collection.geojson",
            "fixtures/metrics/terrestrial-carbon/rothschild-giraffe-gridded-data.json",
        ),
        # (
        #     "fixtures/shapes/canada-feature-collection.geojson",
...
def test_compute_grid(shape_path, metric_path):
    ...
    handler = TerrestrialCarbon(grid=True, simplify=True, best_effort=False)
